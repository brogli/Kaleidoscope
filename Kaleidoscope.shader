...
#include "Packages/com.unity.render-pipelines.high-definition/Runtime/PostProcessing/Shaders/RTUpscale.hlsl"
	...
	float4 CustomPostProcess(Varyings input) : SV_Target
	{
		...
		*****/
		...
		fragmentCoordinates.x = fragmentCoordinates.x * _Zoom / _AspectHeight * _AspectWidth - (_Zoom / 2.0 * _AspectWidth / _AspectHeight);
		fragmentCoordinates.y = fragmentCoordinates.y * _Zoom - _Zoom / 2.0;
		...
		return SAMPLE_TEXTURE2D_X(_InputTexture, s_linear_clamp_sampler, (position + _Offset) * 0.8);
	}
